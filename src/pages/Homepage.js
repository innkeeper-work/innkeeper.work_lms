	...
	return (
		<div className="categoryBg py-4">
			<div className="mx-md-5 px-md-3" id="categories">
				...
				<div className="row g-0 justify-content-center slider">
				...
				<div className="slide-icon d-flex justify-content-center">
					{/* <i className="bi-chevron-left left ps-3" onClick={slideLeft}></i> */}
					{/* <i className="bi-chevron-left left ps-3" onClick={slideLeft}></i>
					<i className="bi-chevron-right right ps-3" onClick={slideRight}></i> */}
				</div>
			</div>
		</div>
	);
