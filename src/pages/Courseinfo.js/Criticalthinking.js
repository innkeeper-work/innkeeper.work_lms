...
let CriticalthinkingInfo = () => {
  return (
    <div>
      <CourseinfoHero coursename="Critical thinking- Creativity" />
      <div className="row justify-content-center">
        <div className="col-lg-7 col-md-6 col-sm-10">
          <AboutCriticalthinking />
          <CriticalthinkingApplyHere />
        </div>
        <div className="col-lg-4 col-md-5 col-sm-10 sectiontwoBg mt-5 h-100">
          <CriticalthinkingReq />
          <CriticalthinkingEnrol />
...
export default CriticalthinkingInfo;
