...
let SuccessfulteamInfo = () => {
  return (
    <div>
      <CourseinfoHero coursename="Working in highly successful team" />
      <div className="row justify-content-center">
        <div className="col-lg-7 col-md-6 col-sm-10">
          <AboutSuccessfulteam />
          <SuccessfulteamApplyHere />
        </div>
        <div className="col-lg-4 col-md-5 col-sm-10 sectiontwoBg mt-5 h-100">
          <SuccessfulteamReq />
          <SuccessfulteamEnrol />
          <SuccessfulteamInstructor />
        </div>
      </div>
      <SuccessfulteamRelated />
    </div>
  );
};

let AboutSuccessfulteam = () => {
  return (
    <div className="">
...
export default SuccessfulteamInfo;
