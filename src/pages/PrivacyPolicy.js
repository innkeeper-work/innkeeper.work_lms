  ...
  return (
    <>
      <div className="container my-5 px-3">
        {/* <h2>INNKEEPER.WORK PRIVACY POLICY</h2> */}
        <div className="my-4">
          {" "}
          <h4 className="herotextColored">INTRODUCTION</h4>
          <p>
            Innkeeper.work (“we” or “us” or “our”) respects the privacy of our
            users (“user” or “you”). This Privacy Policy explains how we
            collect, use, disclose, and safeguard your information when you
            visit our website [www.innkeeper.work] web and mobile application
            [www.innkeeper.work on Moodle], quizzes, forms and survey platforms
            ...
            the site. We reserve the right to make changes to this Privacy
            Policy at any time and for any reason. We will alert you about any
        ...
        <h4 className="herotextColored">COLLECTION OF YOUR INFORMATION</h4>
        <p>
        ...
        <p>
          ...
          stored by our payment processor,
          <a href="https://paystack.com/"> [Paystack]</a> and you are encouraged
        ...
        <div className="my-4">
          {" "}
          <h4 className="herotextColored">USE OF YOUR INFORMATION</h4>
          <p>
            Having accurate information about you permits us to provide you with
            a smooth, efficient, and customized experience. Specifically, we may
            use information collected about you via the Site [or our mobile
            application] to:
          </p>
          <ul className="">
            <li className="">
        ...
        <h4 className="herotextColored">DISCLOSURE OF YOUR INFORMATION</h4>
        <p>
        ...
        <div className="my-4">
          <h4 className="herotextColored">TRACKING TECHNOLOGIES</h4>
          <h6>
          ...
          <p>
            ...
            experience. When you access the Site [or our mobile application],
            ...
            action could affect the availability and functionality of the Site
            [or our mobile application]. You may not decline web beacons.
            ...
            an individual basis. We may use cookies, web beacons, tracking
            pixels, and other tracking technologies on the Site [and our mobile
            application] to help customize the Site [and our mobile application]
            and improve your experience. For more information on how we use
            cookies, please refer to our Cookie Policy posted on the Site, which
            is incorporated into this Privacy Policy. By using the Site, you
            agree to be bound by our Cookie Policy.
          </p>
          <h6>
          ...
          <p>
            ...
            ,] [
            <a href="https://www.cloudflare.com/security-policy/">Cloudflare</a>
            ,] [
            ...
            our mobile application] through the use of first-party cookies and
            third-party cookies, to, among other things, analyze and track
            users’ use of the Site [and our mobile application], determine the
        ...
        <div className="my-4">
          <h4 className="herotextColored">THIRD-PARTY WEBSITES</h4>
          <p>
            {" "}
            ...
            providing any information to any third-party websites, you should
            inform yourself of the privacy policies and practices (if any) of
            the third-party responsible for that website, and should take those
            ...
            other sites, services or applications that may be linked to or from
            the Site [or our mobile application].
          </p>
        </div>

        <h4 className="herotextColored">SECURITY OF YOUR INFORMATION</h4>
        <p>
        ...
        <h4 className="herotextColored">POLICY FOR CHILDREN</h4>
        <p>
        ...
        <h4 className="herotextColored">CONTROLS FOR DO-NOT-TRACK FEATURES </h4>
        <p>
        ...
        <h4 className="herotextColored">OPTIONS REGARDING YOUR INFORMATION</h4>
        <h6>
        ...
        <h4 className="herotextColored">NIGERIAN PRIVACY RIGHTS</h4>
        <p>
          ...
          2007 as subsidiary legislation to the NITDA Act 2007 The NDPR mandates
          all organizations that process the personal data of more than 1000
          data subjects in a period of 6 months and 2000 Data Subjects in a
          period of 12 months to submit a Data Protection Audit report to NITDA
          not later than 15th March every year. Please read details here [{" "}
          <a href="https://ndpr.nitda.gov.ng/Content/Doc/NigeriaDataProtectionRegulation.pdf">
            {" "}
            Nigeria Data Protection Regulation
          </a>
          ]
        </p>
        <h4 className="herotextColored">CONTACT US</h4>
        <p>
